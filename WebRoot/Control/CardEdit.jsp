...
<script type="text/javascript">
	...
	{		
		...
		{
			location.href="<%=path %>/CardServlet?type=4";//点击后跳转至CardServlet Servlet页面
		});
	});
</script>
	...
	<%
	 ...
	 <form action="<%=path %>/CardServlet?type=2" method="post">
		<table style=" margin:50px auto;">
	            <tbody>
			 <tr><td>会员卡编号：</td><td><input type="text" name="card_id" value="<%=obj[0] %>" readonly /></td></tr>
			 <tr><td>车位编号：</td><td>
				<select name="seat_id">
				<%
				     Seat seat=new Seat();
			 ...
			 <tr><td>用户编号：</td><td><input type="text" name="user_id" value="<%=obj[2] %>" /></td></tr>
			 <tr><td>联系方式：</td><td><input type="text" name="user_phone" value="<%=obj[3] %>" required /></td></tr>
