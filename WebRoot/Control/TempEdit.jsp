...
<script type="text/javascript">
	...
	{		
		...
		{
			location.href="<%=path %>/TempServlet?type=4";//点击后跳转至TempServlet Servlet页面
		});
...
<p id="title">编辑临时车辆信息</p>
	...
	<%
	 ...
	 %>
	 <form action="<%=path %>/TempServlet?type=2" method="post">
		<table style=" margin:50px auto;">
	            <tbody>
			 <tr><td>临时编号：</td><td><input type="text" name="temp_id" value="<%=obj[0] %>" readonly="readonly" /></td></tr>
			 ...
			 <tr><td>车位编号：</td><td><input type="text" name="seat_id" value="<%=obj[8] %>" readonly="readonly" /></td></tr>
