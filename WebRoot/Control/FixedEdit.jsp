...
<script type="text/javascript">
	...
	{		
		...
		{
			location.href="<%=path %>/FixedServlet?type=4";//点击后跳转至FixedServlet Servlet页面
		});
	});
</script>
...
<p id="title">公告</p>
	...
	<%
	 ...
	 %>
	 <form action="<%=path %>/FixedServlet?type=2" method="post">
		<table style=" margin:50px auto;">
	            <tbody>
			 <tr><td>记录编号：</td><td><input type="text" name="fixed_id" value="<%=obj[0] %>" /></td></tr>
			 <tr><td>会员卡号：</td><td><input type="text" name="card_id" value="<%=obj[1] %>" /></td></tr>
