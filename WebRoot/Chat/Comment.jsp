...
<div class="div_container">
				...
				out.write("<input type='hidden' name='hvalue' value='"+(request.getAttribute("value")!=null?request.getAttribute("value").toString():"")+"' />");
                		if(list!=null) //循环数据列表，生成表格行
                		{
                			for(int i=0;i<list.size();i++)
	                		{
	               				...
	               				out.print("<tr><td align='center'>"+obj[0]+"</td><td align='center'>"+obj[1]+"</td><td align='center'>"+obj[2]+"</td><td align='center'>"+obj[3]+"</td><td align='center'>"+obj[4]+"</td> </tr>");
	                		}
                		}
	...
	<span class="out">
	<form action="<%=path %>/MessageServlet?type=6" method="post">
        <label for="conteny">请输入留言信息：</label>
<!--         <textarea name="context" cols="45" rows="7"></textarea> -->
